 ...
 */
if ( ! function_exists( 'tailor_modify_section' ) ) {
 ...
 */
if ( ! function_exists( 'tailor_modify_button' ) ) {
 ...
 * @param Tailor_Button_Element $button_element
 */
if ( ! function_exists( 'tailor_add_button_control' ) ) {
 ...
 */
if ( ! function_exists( 'tailor_modify_button_icon_control' ) ) {
