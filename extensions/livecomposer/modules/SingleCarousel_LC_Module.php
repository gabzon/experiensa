...
if ( defined( 'DS_LIVE_COMPOSER_URL' ) ) {
    class SingleCarousel_LC_Module extends DSLC_Module
    {
        var $module_id = 'SingleCarousel_LC_Module';
        var $module_title = 'Single Carousel';
        ...
        function options() {
            ...
            // The options array
            $cpt = (QueryBuilder::checkPostTypeExist('jetpack-testimonial')?'jetpack-testimonial':'post');
            $options = array(
                Query::postType('posttype',$cpt),
    ...
    add_action('dslc_hook_register_modules',
        create_function('', 'return dslc_register_module( "SingleCarousel_LC_Module" );')
    );
}