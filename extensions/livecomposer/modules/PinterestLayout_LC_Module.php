...
if ( defined( 'DS_LIVE_COMPOSER_URL' ) ) {
    class PinterestLayout_LC_Module extends DSLC_Module
    {
        var $module_id = 'PinterestLayout_LC_Module';
        var $module_title = 'Pinterest Layout';
        var $module_icon = 'pinterest';
        ...
        function output( $options ) {
            ...
            if(!empty($showcase_data)) {
                ...
                $name = Query::setSectionName('pinterestlayout',$category,$layout['title']);
    ...
    add_action('dslc_hook_register_modules',
        create_function('', 'return dslc_register_module( "PinterestLayout_LC_Module" );')
    );
}