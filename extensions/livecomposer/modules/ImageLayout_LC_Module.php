...
if ( defined( 'DS_LIVE_COMPOSER_URL' ) ) {
    class ImageLayout_LC_Module extends DSLC_Module
    {
        var $module_id = 'ImageLayout_LC_Module';
        var $module_title = 'Image Layout';
...
//                Background::opacityColor(),
    ...
    add_action('dslc_hook_register_modules',
        create_function('', 'return dslc_register_module( "ImageLayout_LC_Module" );')
    );
}