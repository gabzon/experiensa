...
if ( defined( 'DS_LIVE_COMPOSER_URL' ) ) {
    class FlexLayout_LC_Module extends DSLC_Module
    {
        var $module_id = 'FlexLayout_LC_Module';
        var $module_title = 'Flex Layout';
...
//                Background::opacityColor(),
        ...
        function output( $options ) {
            ...
            if(!empty($showcase_data)) {
                ...
                $name = Query::setSectionName('flexlayout',$category,$layout['title']);
    ...
    add_action('dslc_hook_register_modules',
        create_function('', 'return dslc_register_module( "FlexLayout_LC_Module" );')
    );
}