...
$showcase_textimage_settings = array(
    ...
    'conditions' => array(
        array(
            'field' => 'catalog_section_options:segment_options:content_source_options:source_type',
            'value' => 'showcase'
        )
    )
);
...
$segment_bg_color = array(
    ...
    'conditions' => array(
        array(
            'field' => 'catalog_section_options:segment_options:background_type',
            'value' => 'color'
        )
    )
);
...
$slider_post = array(
    ...
    'conditions' => array(
        ...
        array(
            'field' => 'catalog_section_options:segment_options:content_source_options:slider_options:slider_type',
            'value' => 'posts'
        )
    )
);
...
//
$pages_template = Helpers::getPagesByTemplate('catalog-section.php');
$pages = array(
    'type'      => 'select',
    'field'     => 'pages',
