...
if ( ! function_exists('estimate_post_type') ) {
    ...
    function estimate_post_type($post_types){
        $labels = array(
            'name'                  => _x( 'Estimate', 'Post Type General Name', 'sage' ),
            ...
            'all_items'             => __( 'All Estimates', 'sage' ),
            ...
            'items_list'            => __( 'Estimate list', 'sage' ),
            'items_list_navigation' => __( 'Estimate list navigation', 'sage' ),
            'filter_items_list'     => __( 'Filter Estimate list', 'sage' ),
        );
        $rewrite = array(
            'slug'                  => 'estimate',
            'with_front'            => true,
        ...
        $post_types['estimate'] = array(
            'label'                 => __( 'Estimates', 'sage' ),
            'description'           => __( 'List of Estimates (quotes & estimation)', 'sage' ),
            'labels'                => $labels,
            ...
            'status' => array(
                'quoted'    => array( 'label' => __('requested','sage')),
                'quoted'    => array( 'label' => __('estimated','sage')),
